...
namespace MathIS.Components
{
    internal class WinAPI
    {
        ...
        public static extern int GetCursorPos(ref WinAPI.POINTAPI lpPoint);
        [System.Runtime.InteropServices.DllImport("user32.dll")]
        public static extern int SetLayeredWindowAttributes(System.IntPtr hwnd, int crKey, int bAlpha, int dwFlags);
